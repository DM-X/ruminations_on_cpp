...
nnoremap <F6> :execute "tabmove" tabpagenr() + 1 
nnoremap <F5> :execute "tabmove" tabpagenr() - 2 
...
silent only
cd ~/Desktop/5.4_surrogate_class
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 main.cpp
badd +0 vehiclesurrogate.hpp
badd +0 vehiclesurrogate.cpp
badd +0 vehicle.hpp
badd +0 Makefile
badd +1 VehicleSurrogate.cpp
badd +1 VehicleSurrogate.h
badd +1 vehicle.h
badd +0 mwe.cpp
argglobal
silent! argdel *
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 61 - ((59 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
